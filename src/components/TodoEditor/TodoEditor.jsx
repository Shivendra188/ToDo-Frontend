...
export default function TodoEditor({ open, todo, onClose, onSaved }) {
  ...
  const save = async () => {
    ...
    try {
      ...
      alert("❌ Failed to save todo. Please check backend connection.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={todo ? "Edit todo" : "Create todo"}
    >
      <div className={styles.modal}>
        ...
        <div className={styles.subtasks}>
          <div className="row" style={{ justifyContent: "space-between" }}>
            ...
            <button className="btn" type="button" onClick={addSubtask}>
              Add
            </button>
          </div>
        ...
        >
          ...
          <button className="btn" type="button" onClick={save} disabled={loading}>
            {loading ? "Saving..." : todo ? "Save" : "Create"}
          </button>
        </div>
      </div>
    </div>
